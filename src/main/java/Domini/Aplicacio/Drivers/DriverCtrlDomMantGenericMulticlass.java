...
import Domini.Aplicacio.Stubs.EntitatStubHerencia1;
import Domini.Aplicacio.Stubs.EntitatStubHerencia2;
import Domini.Aplicacio.Stubs.EntitatStubIEntitatDominiHerencia;
import Domini.Controladors.CtrlDomMantGenericMulticlass;

public class DriverCtrlDomMantGenericMulticlass {

		CtrlDomMantGenericMulticlass<EntitatStubIEntitatDominiHerencia> c;
		static Scanner reader;
		
		public void testConstructor() {
			System.out.println("TEST CONSTRUCTOR");
			Map<String, EntitatStubIEntitatDominiHerencia> classes = new HashMap<String, EntitatStubIEntitatDominiHerencia>();
			classes.put(EntitatStubHerencia1.class.getName(), new EntitatStubHerencia1());
			classes.put(EntitatStubHerencia2.class.getName(), new EntitatStubHerencia2());
			
			c = new CtrlDomMantGenericMulticlass<EntitatStubIEntitatDominiHerencia>(classes);
		...
		public void testAltaEntitat() {
			...
			System.out.println("id param {" + EntitatStubHerencia1.class.getName() + " | " + EntitatStubHerencia2.class.getName() + "}");
		...
		public void testAltaNovaEntitat() {
			...
			System.out.println("Introdueïx la classe: (1|2)");
			int cl = reader.nextInt();
			Vector<String> v = new Vector<String>();
			v.add(s);
			String clas = (cl == 1) ? EntitatStubHerencia1.class.getName() : EntitatStubHerencia2.class.getName();
			System.out.println("Classe sel·leccionada: " + clas);
			int exitCode = c.altaNovaEntitat(id, v, clas);
			if (exitCode == 0)
				System.out.println("TEST PASSAT, cap error.");
			else if (exitCode == 1)
		...
		public static void main(String[] args) {
			...
			DriverCtrlDomMantGenericMulticlass d = new DriverCtrlDomMantGenericMulticlass();
